...
ILO_DOMAIN_PAIRS: list[tuple[str, str, str, str]] = [
    ...
    ("ILO_THRESHOLD", "DU_THRESHOLD_AND_PARAMETER_REASONING", "primary",
    ...
    ("ILO_TREE_SPLIT", "DU_THRESHOLD_AND_PARAMETER_REASONING", "secondary",
    ...
    ("ILO_DATA_PATTERN", "DU_THRESHOLD_AND_PARAMETER_REASONING", "secondary",
    ...
    ("ILO_PARAMETER_OPTIMIZATION", "DU_THRESHOLD_AND_PARAMETER_REASONING", "primary",
     "Iterative parameter search and comparative threshold judgment define the merged strategic optimisation domain."),
    ("ILO_MODEL_EVALUATION", "DU_MODEL_EVALUATION", "primary",
     "Integrated performance interpretation is central to evaluation domain."),
    ("ILO_MODEL_EVALUATION", "DU_THRESHOLD_AND_PARAMETER_REASONING", "secondary",
     "Evaluation evidence informs threshold comparison and parameter convergence decisions."),
...
REJECTED_ALTERNATIVES: dict[str, list[dict[str, str]]] = {
    "ILO_INSTANCE": [
        {"domain_id": "DU_THRESHOLD_AND_PARAMETER_REASONING", "reason_rejected": "Instance vocabulary does not evidence strategic cutoff reasoning."},
        {"domain_id": "DU_MODEL_EVALUATION", "reason_rejected": "Naming instances is not model evaluation literacy."},
    ],
    "ILO_FEATURE": [
        {"domain_id": "DU_THRESHOLD_AND_PARAMETER_REASONING", "reason_rejected": "Feature vocabulary alone does not demonstrate threshold comparison or selection."},
    ],
    "ILO_THRESHOLD": [
    ...
    "ILO_RULE": [
        {"domain_id": "DU_THRESHOLD_AND_PARAMETER_REASONING", "reason_rejected": "Rule articulation is structural/procedural, not comparative threshold optimization."},
    ],
    "ILO_DECISION_TREE": [
    ...
    "ILO_METACOGNITIVE_REFLECTION": [
        {"domain_id": "DU_THRESHOLD_AND_PARAMETER_REASONING", "reason_rejected": "Reflection quality must not proxy strategic threshold mastery (leakage L5)."},
    ...
    "ILO_PRIOR_BELIEF": [
        {"domain_id": "DU_THRESHOLD_AND_PARAMETER_REASONING", "reason_rejected": "Uninformed prior belief is diagnostic baseline, not threshold reasoning."},
...
def build_record(ilo_id: str, domain_id: str, role: str, rationale: str, ilo_dim: str) -> dict[str, Any]:
    domain_dims = {
        ...
        "DU_THRESHOLD_AND_PARAMETER_REASONING": "strategic",
