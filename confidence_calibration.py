...
from pipeline_schema import REPO_ROOT, is_interpretive_rubric_item, load_rubric, rubric_item
...
def compute_confidence(
  ...
  Rules (anchor set: Sample_Student human coding, n=127 items):
    ...
    bucket = evaluation_bucket(rubric_item_cfg, worksheet=worksheet, item_id=item_id)
