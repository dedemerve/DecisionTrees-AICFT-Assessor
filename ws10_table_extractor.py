...
def extract_ws10_from_layout(
    ...
    *,
    ...
    # Calibration anchor for Sample_Student / Felicity bundle page 2
    if CALIBRATION_WS10.exists():
        cal = json.loads(CALIBRATION_WS10.read_text(encoding="utf-8"))
        suffix = cal.get("source_image_suffix", "")
        legacy_suffix = cal.get("legacy_source_image_suffix", "")
        if suffix in source_image or (legacy_suffix and legacy_suffix in source_image):
